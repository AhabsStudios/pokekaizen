...
SSAnne1FHiddenObjects:
	hidden_object 33,  0, SPRITE_FACING_UP, OpenPokemonCenterPC
	hidden_object 33,  4, SPRITE_FACING_RIGHT, SSAnne1FRoomsBedHealScript
	hidden_object 33,  5, SPRITE_FACING_RIGHT, SSAnne1FRoomsBedHealScript
	db -1 ; end
