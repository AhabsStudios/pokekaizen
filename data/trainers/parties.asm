...
; Viridian Gym
	db $FF, 50, KANGASKHAN, 48, BEEDRILL, 49, FEAROW, 48, CLOYSTER, 51, PERSIAN, 54, RHYDON, 0 
...
BrunoData:
	db $FF, 56, PRIMEAPE, 53, ONIX, 55, HITMONCHAN, 55, HITMONLEE, 56, PINSIR, 58, MACHAMP, 0

BrockData:
	db $FF, 10, GEODUDE, 12, ONIX, 0

MistyData:
	db $FF, 18, HORSEA, 18, PSYDUCK, 21, STARMIE, 0

LtSurgeData:
	db $FF, 18, VOLTORB, 21, RATICATE, 24, RAICHU, 0

ErikaData:
	db $FF, 28, VICTREEBEL, 30, TANGELA, 28, DRAGONAIR, 28, VILEPLUME, 0

KogaData:
	db $FF, 37, SLOWBRO, 39, MUK, 37, TENTACRUEL, 40, WEEZING, 0

BlaineData:
	db $FF, 42, TAUROS, 44, MAGMAR, 44, RAPIDASH, 43, NINETALES, 46, ARCANINE, 50, MOLTRES, 0

SabrinaData:
	db $FF, 40, HAUNTER, 41, MR_MIME, 42, VENOMOTH, 44, ALAKAZAM, 0
...
LoreleiData:
	db $FF, 54, DEWGONG, 52, SEAKING, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 0
...
AgathaData:
	db $FF, 56, GOLBAT, 57, HYPNO, 57, PARASECT, 58, LICKITUNG, 59, ARBOK, 60, GENGAR, 0

LanceData:
	db $FF, 59, RHYDON, 58, GYARADOS, 58, CHARIZARD, 58, KANGASKHAN, 60, AERODACTYL, 62, DRAGONITE, 0
