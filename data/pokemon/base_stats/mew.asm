	...
	; tm/hm learnset
	tmhm MEGATONPUNCH,   RAZOR_WIND,   SWORDS_DANCE, WHIRLWIND,    MEGATONKICK,    \
	     ...
	     SOFTBOILED,   DREAM_EATER,  GODBIRD,   REST,         THUNDER_WAVE, \
	     MIND_SHOCK,      EXPLOSION,    ROCK_SLIDE,   TRI_ATTACK,   SUBSTITUTE,   \
